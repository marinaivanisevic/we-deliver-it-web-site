...
const en = {
  ...
  hero: {
    ...
    mockupCaption: "Deploy successful",
    mockupCaptionSub: "Just now",
  },
  trusted: {
  ...
  whatWeDo: {
    ...
    description:
      "From strategy and design to development and support, we build digital solutions that drive growth, improve business processes and create exceptional experiences for your users.",
    services: [
      {
        slug: "it-consulting",
        title: "IT Consulting & Technical Specification",
        description:
          "We help companies define a digital strategy, optimise processes and adopt modern technologies. We prepare precise technical documentation that turns an idea into a clear project plan, reduces risk and saves time during development.",
        longDescription: [
          "Not sure whether your requirements for an IT project are properly defined, or how to solve the challenges already present in your operations?",
          "Money invested in IT consulting is not a cost but an investment that pays back many times over through more efficient development, more stable operation and lower costs in the long run.",
          "A good idea on its own is not enough — it takes a technically literate specialist to turn it into a clear specification. Just as construction projects are never done without an independent engineer, an IT project should not start without precise technical documentation that saves development time and money, and ensures the development team understands exactly what is being built.",
          "We stay with you through delivery as well — technical supervision, help with procuring equipment and expert project leadership — so the result is a modular, robust solution rather than a pile of improvisations.",
          "Our team holds internationally recognised experience and certifications, earned working with development agencies, government institutions and international financial organisations — which makes the specifications we write hold up against real audit and compliance requirements.",
        ],
        features: [
          "IT advisory and strategic planning",
          "Technical specification for IT projects",
          "IT project supervision and management",
          "IT equipment procurement and tracking",
      ...
      },
      {
        ...
        description:
          "We design and build websites, custom software solutions and cross-platform mobile apps for iOS and Android — every project combines solid technical foundations with excellent user experience.",
        longDescription: [
          "Need a website, a software solution or a mobile app you can easily extend and maintain? We build solutions clients update and improve on their own, while we take care of everything that doesn't earn them money directly — hosting, maintenance and updates.",
          "Custom websites, built on WordPress or a bespoke solution — with responsive design, contact form, Google Maps, newsletter signup, live chat and social media integration.",
          "Custom software solutions and internal tools, from simple portals to complex business systems — we design the architecture and database so the solution grows with your business, with integration into existing systems (ERP, CRM, payments) whenever you need it.",
          "Cross-platform mobile apps for iOS and Android from a single codebase, with a native feel on both operating systems — including offline mode, push notifications, in-app payments and publishing to the App Store and Play Store.",
          "Through team augmentation we also reinforce existing development teams when you lack capacity or specific expertise, and we work in short, visible iterations — from initial architecture to weekly builds you can test yourself — with automated testing, so the code stays readable well past the first release.",
        ],
        features: [
          "Custom website development (WordPress or bespoke)",
          "Custom software solutions and internal tools",
          "Cross-platform mobile apps (iOS and Android)",
          "Team augmentation and outsourced development",
          "Contact forms, Google Maps and newsletter integration",
          "SEO optimisation and GDPR compliance",
      ...
      },
      {
        ...
        description:
          "We develop e-commerce platforms that increase sales and customer loyalty. From product management and payments to SEO optimisation — we deliver complete solutions for selling online.",
        longDescription: [
          "Need an online store with card payments, multiple languages and currencies, or a shipping calculator based on parcel weight? We build complete e-commerce solutions that give you full control over your own store — from products and categories to orders and payments.",
          "The system is designed to grow with you: simple, grouped and variable products, reservations, stock and order tracking, with support for further integrations whenever you need them.",
          "Customers get a secure, straightforward buying experience on every device, while you get an overview of orders, revenue and stock in one place.",
          "After launch we remain available for further development — new features, additional payment integrations or expansion into new markets.",
        ],
        features: [
          "Stock and order management",
          "Card and PayPal payment integration",
          "Shipping cost calculation by weight and destination",
      ...
      },
      {
        ...
        description:
          "We build tailored LMS systems with interactive features, progress tracking and responsive design — helping organisations deliver modern online education.",
        longDescription: [
          "Education is one of the most fundamental ways to create value — which is why we build e-learning platforms that make it easier to create, manage and deliver courses, whether you are training employees or selling your own courses.",
          "Content can be text, images or video, with quizzes and learner progress tracking, and lessons are modular so they can easily be reused and extended for new courses.",
          "The platform suits internal employee training just as well as selling your own courses to a wider audience — you define access, pricing and categories yourself.",
          "We adapt the interface design to your brand, so learners feel they are studying on your platform rather than someone else's generic tool.",
        ],
        features: [
          ...
          "Modular, reusable lessons",
          "Certificate issuing and tracking",
        ],
      },
      {
        slug: "ai-blockchain",
        title: "AI, Blockchain & Emerging Technologies",
        description:
          "Put artificial intelligence, machine learning and blockchain to work for new business opportunities. From tokenisation to smart contracts — we guide you through adopting advanced technologies, securely and efficiently.",
        longDescription: [
          "You can see that blockchain technologies are the future and could help you grow the business, but you need consulting you can rely on? Our team has experience developing security tokens, crypto exchanges and blockchain platforms, and brings that knowledge straight to your project.",
          "Understanding and correctly applying these technologies creates a competitive advantage — whether you are an individual or a company just entering the field. Alongside blockchain, we also help assess where AI, machine learning, IoT and serverless architectures can realistically add value to your business.",
          "There is concrete experience behind us — from developing security tokens and crypto exchanges to a blockchain platform for a smart city — knowledge we pass directly on to your project.",
          "Before we recommend adopting anything, we assess feasibility and risk together, so the decision to introduce a new technology is well founded rather than a passing trend.",
        ],
        features: [
          "Blockchain consulting and strategy",
          "Smart contract development",
          "Tokenisation and crypto solutions",
          "Artificial intelligence and machine learning integration",
          "IoT and serverless architectures",
          "Business process analysis and modernisation",
        ],
      },
      {
        slug: "design-qa",
        title: "Product Design, UX/UI & QA Testing",
        description:
          "We create user-centred design that pairs a polished interface with an intuitive experience, then safeguard quality, security and performance through automated and manual testing strategies.",
        longDescription: [
          "A good product is built around real users, not the other way round. We combine UX research and UI design with consistent quality control, so what we deliver is both intuitive and dependable.",
          "From wireframes and interactive prototypes to automated test suites and manual testing — we cover the whole path from idea to a stable release.",
          "The process runs from user research and wireframes, through interactive prototypes, to a final design aligned with your brand — each step validated before moving on to the next.",
          "We verify quality through a combination of automated and manual testing across different devices and browsers, including performance and security checks before every release.",
        ],
        features: [
...
const sr: typeof en = {
  ...
  hero: {
    ...
    mockupCaption: "Uspešan deploy",
    mockupCaptionSub: "Upravo sada",
  },
  trusted: {
