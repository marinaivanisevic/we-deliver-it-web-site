...
const HeroIcon = iconBySlug["online-store"];
const heroIconColor = iconColorBySlug["online-store"];
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="relative pt-28 lg:pt-36 pb-16 lg:pb-24 overflow-hidden">
        ...
        <div className="container relative max-w-6xl">
          ...
          {/* Feature grid: 12 e-commerce features — "bento" raspored: istaknuta kartica + ostale ispod */}
          <div className="mt-14">
